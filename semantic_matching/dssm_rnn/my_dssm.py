...
with tf.name_scope('word_embeddings_layer'):
    ...
    doc_pos_embed = tf.nn.embedding_lookup(_word_embedding, doc_positive_batch, name='doc_positive_embed')
    doc_neg_embed = tf.nn.embedding_lookup(_word_embedding, doc_negative_batch, name='doc_negative_embed')
